            ...
            for(var i = 0;i<g_array_new.length;i++){
                ...
                if(g_array_new[i].date.length >0){
                        ...
                        if(g_array_new[i].date.includes("Mo") == true){
                            var stime = g_array_new[i].stime.slice(4);
                            var etime = g_array_new[i].etime.slice(4);
                            
                            console.log("Printmo" + stime + "and" + etime);
                            document.getElementById("mo").innerHTML =oldHTML_mo + "<li class='single-event' data-start='"+stime+"'data-end='"+etime+"'data-content='' data-event='event-2'><a href='#0'><em class='event-name'>"+ g_array_new[i].name + "</em></a></li>"
                        }
                        if(g_array_new[i].date.includes("Tu")== true){
                            var stime = g_array_new[i].stime.slice(4);
                            var etime = g_array_new[i].etime.slice(4);
                            console.log("Printtu"+ stime + "and" + etime);
                            document.getElementById("tu").innerHTML =oldHTML_tu+"<li class='single-event' data-start='"+stime+"'data-end='"+etime+"'data-content='' data-event='event-2'><a href='#0'><em class='event-name'>"+ g_array_new[i].name + "</em></a></li>"
                        }
                        if(g_array_new[i].date.includes("We")== true){
                           var stime = g_array_new[i].stime.slice(4);
                            var etime = g_array_new[i].etime.slice(4);
                            console.log("Printwe"+ stime + "and" + etime);
                            document.getElementById("we").innerHTML =oldHTML_we+"<li class='single-event' data-start='"+stime+"'data-end='"+etime+"'data-content='' data-event='event-2'><a href='#0'><em class='event-name'>"+ g_array_new[i].name + "</em></a></li>"
                        }
                        if(g_array_new[i].date.includes("Th")== true){
                            var stime = g_array_new[i].stime.slice(4);
                            var etime = g_array_new[i].etime.slice(4);
                           console.log("Printth"+ stime + "and" + etime);
                            document.getElementById("th").innerHTML =oldHTML_th+"<li class='single-event' data-start='"+stime+"'data-end='"+etime+"'data-content='' data-event='event-2'><a href='#0'><em class='event-name'>"+ g_array_new[i].name + "</em></a></li>"
                        }
                        if(g_array_new[i].date.includes("Fr")== true){
                            var stime = g_array_new[i].stime.slice(4);
                            var etime = g_array_new[i].etime.slice(4);
                            console.log("Printfr"+ stime + "and" + etime);
                            document.getElementById("fr").innerHTML =oldHTML_fr+"<li class='single-event' data-start='"+stime+"'data-end='"+etime+"'data-content='' data-event='event-2'><a href='#0'><em class='event-name'>"+ g_array_new[i].name + "</em></a></li>"
                        }
